...
export const metadata: Metadata = {
  title: 'Voucher Social NFT | Benefícios Digitais',
  description:
    'Aplicativo de voucher social com NFTs para benefícios governamentais e programas sociais.',
  generator: 'v0.app',
  manifest: '/manifest.json',
  appleWebApp: {
    capable: true,
    statusBarStyle: 'default',
    title: 'Voucher Social',
  },
  formatDetection: {
    telephone: false,
  },
...
export default function RootLayout({
  ...
  return (
    <html lang="pt-BR" className="bg-emerald-50">
      <head>
        {/* PWA meta tags para iOS */}
        <meta name="mobile-web-app-capable" content="yes" />
        <meta name="apple-mobile-web-app-capable" content="yes" />
        <meta name="apple-mobile-web-app-status-bar-style" content="default" />
        <meta name="apple-mobile-web-app-title" content="Voucher Social" />
        {/* Ícones Apple */}
        <link rel="apple-touch-icon" href="/icons/icon-192x192.png" />
        <link rel="apple-touch-icon" sizes="152x152" href="/icons/icon-152x152.png" />
        <link rel="apple-touch-icon" sizes="192x192" href="/icons/icon-192x192.png" />
        <link rel="apple-touch-icon" sizes="512x512" href="/icons/icon-512x512.png" />
        {/* Splash screens iOS — evita tela branca ao abrir */}
        ...
        <link rel="apple-touch-startup-image" media="screen and (device-width: 768px) and (device-height: 1024px) and (-webkit-device-pixel-ratio: 2)" href="/icons/icon-512x512.png" />
      </head>
